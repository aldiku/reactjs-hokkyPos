...
const CreateAllCabang = () => {
  ...
  return (
    <div>
      <SimpleHeader name="Daftar Cabang" parentName="Master" />
            ...
            <Card>
              <Form onSubmit={handleSubmit}>
                ...
                <CardFooter>
                    ...
                    <Link className="btn btn-info" to="/admin/warehouse/gudang">
                      Kembali
                    </Link>
                </CardFooter>
               </Form>      
...
export default CreateAllCabang;