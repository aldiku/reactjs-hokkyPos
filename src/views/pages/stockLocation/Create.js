...
export default function CreateStockLocation() {
  ...
  function CreateData() {
    ...
    axios.post(`${process.env.REACT_APP_API_BASE_URL}/warehouse/pusat/save`, data, {
      headers: {
        Authorization: `Bearer ${token}`,
      }
    })
  ...
  return (
    <>
      <SimpleHeader name="Daftar Stock Location" parentName="Admin" />
