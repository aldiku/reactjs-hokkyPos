...
const AdjustmentPage = () => {
  ...
  const redirectPrefix = `/admin/stock-adjustment/edit/`;
  const redirectPrefix1 = `/cetak/stock-adjustment/cetak/`;
              ...
              <CardHeader>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <Link className="btn btn-info" to="/admin/stock-adjustment/create">
                      Tambah
                    </Link>
                  </div>
                </div>
              ...
              <CardBody>
                      <Form>
                        <Row md="12">
                          <Col md="3">
                            <FormGroup>
                              <Label htmlFor="exampleFormControlSelect3">Kode Adjustment</Label>
                              <Input
                                type="text"
                                placeholder="Masukan Kode Adjustment"
                                value={uomCode}
